...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $sql = <<<SQL
                    ...
                    RETURNS TABLE(id bigint, message text, amount numeric, date_operation timestamp without time zone, type_transaction character varying, category_id bigint, detail_id bigint, detail_name character varying, frequency_general jsonb, frequency bigint, yape_trans jsonb, yape_id bigint, user_id bigint, source_type text,
                        suggested_category_id bigint,
                        suggest_name character varying,
                        total_count bigint)
                    LANGUAGE sql
                    AS $$
                                SELECT * FROM (
