...
return new class extends Migration
{
    ...
    public function up(): void
    {
        $this->down();
        $sql = <<<SQL
                    CREATE OR REPLACE FUNCTION public.get_transactions(p_per_page integer, p_page integer, p_year integer, p_month integer, p_type type_transaction, p_amount numeric, p_search character varying, p_category text, p_user_id integer, p_recurring boolean, p_weekend boolean, p_workday boolean)
                                                        ...
                                                        SELECT * FROM (
                                                            ...
                                                            PRE_FILTERED_YAPES AS (
                                                                ...
                                                                SELECT
                                                                    ...
                                                                    d.description detail_name, ty.user_id, ty.category_id, ty.suggested_category_id, 
