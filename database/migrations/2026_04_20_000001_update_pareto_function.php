...
SQL;
    ...
    {
        // Revert to original (using categories.pareto_classification_id)
        // Note: This assumes categories table has the column back (handled by down() of the decoupling migration)
        $sql = <<<SQL
            CREATE OR REPLACE FUNCTION get_pareto_monthly_report (
                p_user_id integer,
                p_month integer,
